...
<![endif]-->
<meta charset="utf-8">
<title>Download Shared File - Mizzou1</title>
...
&nbsp;
<button type="button" class="btn btn-success" data-toggle="modal" href="#responsive">Share</button>
</div>
...
Download the file directly to your mobile devices by scanning QR-code below<br>
  ...
  <a href="<?php echo($fulllongurl);?>"><?php echo($fulllongurl);?></a>
</div>
